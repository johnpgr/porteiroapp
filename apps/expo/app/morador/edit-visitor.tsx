...
import type { PreRegistrationData } from '~/components/morador/visitantes/types';
...
export default function EditVisitorScreen() {
  ...
  const params = useLocalSearchParams<{
    ...
    name?: string;
    phone?: string;
    onSubmit?: string; // Will be handled differently
  }>();
  ...
  // Initialize form when params change
  useEffect(() => {
  ...
  }, [editData, isSubmitting, handleClose]);
