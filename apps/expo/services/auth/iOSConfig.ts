import { createSupabaseClient, SupabaseConfig, TypedSupabaseClient } from '@porteiroapp/common/supabase';
...
export class iOSConfigManager {
  ...
  public getSupabaseConfig(
    ...
    } satisfies SupabaseConfig['options'];
