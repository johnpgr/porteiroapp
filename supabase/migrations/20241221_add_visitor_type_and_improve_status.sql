-- Migração para adicionar tipo de visitante e melhorar controle de status
-- Data: 2024-12-21
-- Descrição: Adiciona campo visitor_type na tabela visitors e melhora controle de status

-- 1. Adicionar campo visitor_type na tabela visitors
...
-- 3. Atualizar visitantes existentes para tipo 'comum' se não especificado
UPDATE visitors 
...
-- 5. Função para controlar automaticamente o status após entrada
...
-- 6. Criar trigger para controle automático de status
