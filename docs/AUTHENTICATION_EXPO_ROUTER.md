...
> **info** **Note:** This guide requires SDK 53 and later. For the previous version of this guide see [Authentication (redirects)](https://docs.expo.dev/router/advanced/authentication-rewrites/).
...
[How to use Protected Routes in Expo Router version 5 and later for smooth authentication](https://www.youtube.com/watch?v=XCTaMu0qnFY)
