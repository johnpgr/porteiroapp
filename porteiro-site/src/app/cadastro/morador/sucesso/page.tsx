            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                <a 
                  ...
                  className="bg-white hover:bg-gray-50 text-blue-600 border-2 border-blue-600 px-4 py-2 rounded-md font-medium transition-colors inline-flex items-center justify-center"
                >
                  👤 Portal do Morador
                </a>
