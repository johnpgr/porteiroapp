...
import { CheckCircle, Smartphone, Shield, Users, Clock, ArrowRight, Download, LogIn, Sparkles } from 'lucide-react';
import Link from 'next/link';

interface SuccessPageProps {
  tipo?: 'visitante' | 'morador';
}
...
export default function SuccessPage() {
  ...
  useEffect(() => {
    const tipoParam = searchParams.get('tipo') as 'visitante' | 'morador';
        ...
        features: [
          {
            ...
            title: 'Acesso Rápido',
            description: 'Use seu celular para entrar no condomínio'
          },
          {
            icon: <Shield className="w-6 h-6" />,
            title: 'Segurança Total',
            description: 'Seus dados estão protegidos e criptografados'
          },
          {
            icon: <Clock className="w-6 h-6" />,
            title: 'Disponível 24h',
            description: 'Acesse a qualquer hora do dia ou da noite'
          }
        ],
        actions: [
          {
        ...
        features: [
          {
            ...
            description: 'Gerencie visitantes, encomendas e reservas'
          },
          {
            icon: <Shield className="w-6 h-6" />,
            title: 'Controle Total',
            description: 'Monitore e controle o acesso ao seu apartamento'
          },
          {
            icon: <Sparkles className="w-6 h-6" />,
            title: 'Recursos Premium',
            description: 'Acesso a todas as funcionalidades exclusivas'
          }
        ],
        actions: [
          {
